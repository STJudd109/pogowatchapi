...
app.get('/api/account', function (req, res) {
    ...
    a.GetProfile(function(err, profile) {
        ...
        res.sendStatus({ "username": profile.username, "storage": profile.poke_storage, "istorage": profile.item_storage, "stardust": profile.currency[1].amount, "pokecoins": profile.currency[0].amount});
